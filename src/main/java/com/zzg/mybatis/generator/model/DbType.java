...
public enum DbType {
    ...
    MySQL("com.mysql.jdbc.Driver", "jdbc:mysql://%s:%s/%s?useUnicode=true&useSSL=false&tinyInt1isBit=false&characterEncoding=%s", "mysql-connector-java-5.1.38.jar"),
    MySQL_8("com.mysql.cj.jdbc.Driver", "jdbc:mysql://%s:%s/%s?serverTimezone=UTC&useUnicode=true&useSSL=false&tinyInt1isBit=false&characterEncoding=%s", "mysql-connector-java-8.0.11.jar"),
